    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                try {
//                    BluetoothFragment mBluetoothPopUpActivity = new BluetoothFragment();
//                    Context c = mContext;
//                    mBluetoothPopUpActivity.getActivity().runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
...
//                    });
    ...
    private class ConnectedThread extends Thread{
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            mContext.sendBroadcast(connectionStatus);
        ...
        public void run(){
            ...
            while(true){
                try {
                    ...
                    mContext.sendBroadcast(incomingMessageIntent);
                } catch (IOException e) {
